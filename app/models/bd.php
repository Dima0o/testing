...
class bd {
	...
	//Констуктор, подключение к БД и т.п.
	private function __construct() {
		...
		$this->bd_base = $bd_base;

		//Подключение к БД
		$this->conn = new mysqli(''.$this->bd_db.'', ''.$this->bd_user.'', ''.$this->bd_password.'', ''.$this->bd_base.'');
	...
	public function queryNoPrepare($sql)
	{
	...
	private function save_cache ($query,$result){
